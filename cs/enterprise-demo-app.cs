...
namespace Bend.Util
{
    ...
    {
        protected TelegramMessageSender msgSender;

        public WebhookHttpServer(int port)
            : base(port)
        {
            msgSender = new TelegramMessageSender();
        }
        ...
        {
            Console.WriteLine("Received a message from a user!!");
            Console.WriteLine("His number is " + userNumber);
            Console.WriteLine("His message is " + userMessage);
    ...
    public class TelegramMessageSender
    {
        ...
        private static string API_URL = "https://enterprise.whatsmate.net/v1/telegram/single/message/" + INSTANCE_ID;
    ...
    public class DemoMain
    {
        public static int Main(String[] args)
        {
            ...
            {
                httpServer = new WebhookHttpServer(8080);
            }
