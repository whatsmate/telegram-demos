...
function demoSendTelegramImageInDrive() {
  ...
  sendTelegramImage(destNumber, imageBase64);
}


function sendTelegramImage(destNumber, imageBase64) {
  ...
  UrlFetchApp.fetch("https://api.whatsmate.net/v3/telegram/single/image/message/" + instanceId, options);
}
