...
var jsonPayload = JSON.stringify({
    ...
    audio: fs.readFileSync("../assets/ocean-waves.mp3").toString('base64'),  // FIXME
    filename: "anyname.mp3", // FIXME
    caption: "Enjoy the nature"  // FIXME
});

var options = {
    hostname: "api.whatsmate.net",
    port: 80,
    path: "/v3/telegram/single/audio/message/" + instanceId,
    method: "POST",
    headers: {
