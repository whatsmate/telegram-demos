Sub Main_Routine()
  ...
  ''' The third parameter is the full path to the image file.
  ''' The fourth parameter is the caption of the image.
  TelegramImage_SendToGroup "Muscle Men Club", "19159876123", "C:\Users\Public\cute-girl.jpg", "Lovely Girl"    ''' TODO: Specify the group name and group admin
End Sub


Sub TelegramImage_SendToGroup(ByRef group_name As String, ByRef group_admin As String, ByRef strFilename As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/group/image/message/" & INSTANCE_ID

  contentInBase64 = ConvertFileToBase64(strFilename)
  strJson = "{""group_name"": """ & group_name &  """, ""group_admin"": """ & group_admin &  """, ""image"": """ & contentInBase64 & """, ""caption"": """ & strCaption & """}"
