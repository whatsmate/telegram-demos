Sub Main_Routine()
  ...
  ''' The second parameter is the full path to the voice note file (e.g. OPUS file)
  ''' The third parameter is the filename displayed to the recipient.
  ''' The fourth parameter is the caption for the voice note file.
  TelegramAudio_Send "12025550108", "C:\Users\Public\martin-luther-king.opus", "anyname.opus", "I have a dream"     ''' TODO: Specify the recipient's number here. NOT the gateway number
End Sub


Sub TelegramAudio_Send(ByRef strNumber As String, ByRef strFilename As String, ByRef strDisplayName As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/single/voice_note/message/" & INSTANCE_ID

  contentInBase64 = ConvertFileToBase64(strFilename)
  strJson = "{""number"": """ & strNumber & """, ""voice_note"": """ & contentInBase64 & """, ""filename"": """ & strDisplayName & """, ""caption"": """ & strCaption & """}"
