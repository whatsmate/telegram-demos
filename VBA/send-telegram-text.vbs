Sub Main_Routine()
  ...
  TelegramMessage_Send "12025550108", "God Loves You"   ''' TODO: Specify the recipient's number here. NOT the gateway number
End Sub
...
Sub TelegramMessage_Send(ByRef strNumber As String, ByRef strMessage As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/single/text/message/" & INSTANCE_ID
