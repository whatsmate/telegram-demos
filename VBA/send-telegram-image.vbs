Sub Main_Routine()
  ...
  TelegramImage_Send "12025550108", "C:\Users\Public\cute-girl.jpg", "Lovely Girl"    ''' TODO: Specify the recipient's number here. NOT the gateway number
End Sub


Sub TelegramImage_Send(ByRef strNumber As String, ByRef strFilename As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/single/image/message/" & INSTANCE_ID
