Sub Main_Routine()
  ...
  ''' The fourth parameter is the caption for the document.
  TelegramDoc_Send "12025550108", "C:\Users\Public\subwaymap.pdf", "click_me.pdf", "Check this out"     ''' TODO: Specify the recipient's number here. NOT the gateway number
End Sub


Sub TelegramDoc_Send(ByRef strNumber As String, ByRef strFilename As String, ByRef strDisplayName As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/single/document/message/" & INSTANCE_ID
