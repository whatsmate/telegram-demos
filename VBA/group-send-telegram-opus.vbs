...
Sub TelegramVoice_GroupSend(ByRef group_name As String, ByRef group_admin As String, ByRef strFilename As String, ByRef strDisplayName As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/group/voice_note/message/" & INSTANCE_ID

  contentInBase64 = ConvertFileToBase64(strFilename)
  strJson = "{""group_name"": """ & group_name &  """, ""group_admin"": """ & group_admin &  """, ""voice_note"": """ & contentInBase64 & """, ""filename"": """ & strDisplayName & """, ""caption"": """ & strCaption & """}"
