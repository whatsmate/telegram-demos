Sub Main_Routine()
  ...
  ''' The second parameter is the full path to the audio file (e.g. MP3 file)
  ''' The third parameter is the filename displayed to the recipient.
  ''' The fourth parameter is the caption for the audio file.
  TelegramAudio_Send "12025550108", "C:\Users\Public\ocean-waves.mp3", "anyname.mp3", "Enjoy the nature"     ''' TODO: Specify the recipient's number here. NOT the gateway number
End Sub
...
Sub TelegramAudio_Send(ByRef strNumber As String, ByRef strFilename As String, ByRef strDisplayName As String, ByRef strCaption As String)
  ...
  API_URL = "https://api.whatsmate.net/v3/telegram/single/audio/message/" & INSTANCE_ID

  contentInBase64 = ConvertFileToBase64(strFilename)
  strJson = "{""number"": """ & strNumber & """, ""audio"": """ & contentInBase64 & """, ""filename"": """ & strDisplayName & """, ""caption"": """ & strCaption & """}"
